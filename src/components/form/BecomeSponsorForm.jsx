...
const BecomeSponsorForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`${API_URL}/sponsors-requests`, {
                method: "POST",
                headers: {
    ...
    return (
        <form onSubmit={handleSubmit} className='form-inline'>
            <h2 className='mb-3'>Become a Sponsor</h2>
            ...
            <div className="form-group mb-3">
                ...
                <input type="text" name="website" className='form-control no-arrows' placeholder="website" autoComplete='off' required />
            </div>
            {/* <div className="form-group">
