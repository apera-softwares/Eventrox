              ...
              <div className="title-column col-lg-4 col-md-6 col-sm-12">
                <div className="inner">
                  <div className="sec-title light">
                    ...
                    <h2>REGISTER NOW</h2>
                    <div className="text">
                      Secure your spot at the Future of Work HR Conference. Gain
                      insights from visionary leaders, explore cutting-edge HR
                      tech, and connect with professionals shaping the workplace
                      of tomorrow.
                    </div>
                  </div>
                </div>
